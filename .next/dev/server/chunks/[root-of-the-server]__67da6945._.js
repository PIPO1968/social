...
"[project]/src/app/api/trofeos/user-trofeos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error fetching user trofeos'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        // Delete existing
        await prisma.userTrofeo.deleteMany({
            where: {
                userId: user.id
            }
        });
        // Create new
        const trofeos = [];
        trofeosDesbloqueados.forEach((id)=>{
            trofeos.push({
                userId: user.id,
                trofeoId: id,
                desbloqueado: true
        ...
        await prisma.userTrofeo.createMany({
            data: trofeos
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error updating user trofeos'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67da6945._.js.map