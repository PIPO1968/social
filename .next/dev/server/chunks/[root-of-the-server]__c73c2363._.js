...
"[project]/src/app/api/premium/competiciones/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(competicionData || {
            victorias: 0,
            participaciones: 0,
            puntuacionTotal: 0
        });
        ...
        try {
            ...
            torneos.forEach((torneo)=>{
                if (torneo.resultados && Array.isArray(torneo.resultados)) {
                    ...
                    const resultadosUsuario = torneo.resultados.filter((r)=>r.nick && decoded.nick && normalizar(r.nick) === normalizar(decoded.nick));
                    if (resultadosUsuario.length > 0) {
                        // Tomar el mejor resultado (mayor puntuación)
                        const mejor = resultadosUsuario.reduce((max, curr)=>curr.puntuacion > max.puntuacion ? curr : max, resultadosUsuario[0]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c73c2363._.js.map