...
const PerfilUsuario = ()=>{
    ...
    const [tieneMensajesSinLeer, setTieneMensajesSinLeer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [selectedUserData, setSelectedUserData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Estados para datos de base de datos
    const [premiumData, setPremiumData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [userTrofeos, setUserTrofeos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        trofeosDesbloqueados: [],
        trofeosBloqueados: []
    });
    const [displayedUserProfile, setDisplayedUserProfile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const displayedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PerfilUsuario.useMemo[displayedUser]": ()=>selectedUser ? selectedUserData || {
                ...user,
    ...
    }["PerfilUsuario.useMemo[displayedUser]"], [
        selectedUser,
        selectedUserData,
        user,
        userTrofeos
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PerfilUsuario.useEffect": ()=>{
            // Obtener concursos
            fetch('/api/concursos').then({
                "PerfilUsuario.useEffect": (response)=>response.json()
            }["PerfilUsuario.useEffect"]).then({
                "PerfilUsuario.useEffect": (concursos)=>{
                    setConcursos(concursos);
                    // Calcular el próximo ID basado en los concursos existentes
                    const maxNumero = concursos.length > 0 ? Math.max(...concursos.map({
                        "PerfilUsuario.useEffect": (c)=>c.numero
                    }["PerfilUsuario.useEffect"])) : 0;
                    setConcursoId(maxNumero + 1);
                }
            }["PerfilUsuario.useEffect"]).catch({
                "PerfilUsuario.useEffect": (error)=>{
            ...
            fetch('/api/users').then({
                ...
                "PerfilUsuario.useEffect": (users)=>{
                    if (Array.isArray(users)) {
                        // Ordenar alfabéticamente por nick
                        users.sort({
                            "PerfilUsuario.useEffect": (a, b)=>a.nick.localeCompare(b.nick, 'es', {
                                    sensitivity: 'base'
                                })
                        }["PerfilUsuario.useEffect"]);
                        setUsuarios(users);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PerfilUsuario.useEffect": ()=>{
            if (user && user.nick) {
                fetch('/api/premium/data?nick=' + user.nick).then({
                    "PerfilUsuario.useEffect": (response)=>response.json()
                }["PerfilUsuario.useEffect"]).then({
                    "PerfilUsuario.useEffect": (data)=>{
                        if (data && !data.error) {
                            setPremiumData(data);
                        } else {
                            setPremiumData(null);
                ...
                fetch('/api/user/profile?nick=' + user.nick).then({
                    "PerfilUsuario.useEffect": (response)=>response.json()
                }["PerfilUsuario.useEffect"]).then({
                    "PerfilUsuario.useEffect": (profileData)=>{
                        if (profileData && profileData.user) {
                            ...
                            fetch('/api/trofeos/user-trofeos?nick=' + user.nick).then({
                                "PerfilUsuario.useEffect": (response)=>response.json()
                            }["PerfilUsuario.useEffect"]).then({
                                "PerfilUsuario.useEffect": (trofeosData)=>{
                ...
                fetch('/api/friends?action=requests&nick=' + user.nick).then({
                    "PerfilUsuario.useEffect": (response)=>response.json()
                }["PerfilUsuario.useEffect"]).then({
                    "PerfilUsuario.useEffect": (data)=>{
                        if (data.requests) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PerfilUsuario.useEffect": ()=>{
            if (user && user.nick) {
                fetch('/api/chat?nick=' + user.nick).then({
                    "PerfilUsuario.useEffect": (response)=>response.json()
                }["PerfilUsuario.useEffect"]).then({
                    "PerfilUsuario.useEffect": (messages)=>{
                        ...
                        const lastReceived = messages.filter({
                            "PerfilUsuario.useEffect.lastReceived": (msg)=>msg.to === user.nick
                        }["PerfilUsuario.useEffect.lastReceived"]).map({
                            "PerfilUsuario.useEffect.lastReceived": (msg)=>{
                                // Parsear fecha robustamente
                                const d = msg.fecha ? Date.parse(msg.fecha) : NaN;
                                return isNaN(d) ? 0 : d;
                            }
                        }["PerfilUsuario.useEffect.lastReceived"]).reduce({
                            "PerfilUsuario.useEffect.lastReceived": (max, curr)=>Math.max(max, curr)
                        }["PerfilUsuario.useEffect.lastReceived"], 0);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$renderNick$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderNick"])(request.solicitante.nick)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/perfil/page.tsx",
                                                lineNumber: 851,
                                                columnNumber: 78
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    tieneMensajesSinLeer && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: TROFEOS.slice(0, 24).map((trofeo, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    !isTrofeoUnlocked(displayedUser, idx) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$trofeosPremiumImport$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TROFEOS_PREMIUM"].map((trofeo, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    !isTrofeoUnlocked(displayedUser, TROFEOS.length + idx) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "absolute inset-0 flex items-center justify-center",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-red-600 text-4xl font-bold",
                                                            children: "✕"
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        usuarios.filter((u)=>u.nick !== user.nick).map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: u.nick,
                                                children: u.nick
                                            }, u.nick, false, {
                                                fileName: "[project]/src/app/perfil/page.tsx",
...
_s(PerfilUsuario, "BHUMPXShQWcv06+M77Il4Lsjlac=", false, function() {
    return [
